...
// Prefer legacyItemId (plain numeric) over the compound Browse-native itemId
// ("v1|123456789|0") - once logged in, tapping a search result routes through
// Trading API's GetItem (see EBayData.getItem), which expects the legacy
// numeric ItemID and otherwise fails with an obscure eBay-side error rather
// than a clear "invalid item id" message. Not every listing has a
