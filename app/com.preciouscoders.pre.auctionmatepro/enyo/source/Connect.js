...
try{
var _qr=qrcode(0,"M");
_qr.addData(_json.useUrl);
_qr.make();
this.$.codeQr.setSrc(_qr.createDataURL(4,8));
}
catch(_qrErr){
pc.Log.logException(_qrErr);
}
